  ...
  return (
    <svg className="h-9 w-[96px] shrink-0 sm:h-10 sm:w-[106px]" viewBox="0 0 168 60" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6 20.2C6 14.2 10.4 9.2 16.3 8.3L55 2.5C61 1.6 66.4 6.2 66.4 12.2V19.8H49.6L47.9 16.5L23.1 20.4V39.6L47.9 43.5L49.6 40.2H66.4V47.8C66.4 53.8 61 58.4 55 57.5L16.3 51.7C10.4 50.8 6 45.8 6 39.8V20.2Z"
        fill="url(#cmbSide)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M68 14.8C68 10.5 71.5 7 75.8 7H116.2C120.5 7 124 10.5 124 14.8V53H110V21.6H102.6V39.4C102.6 44.5 99.8 48 96 48C92.2 48 89.4 44.5 89.4 39.4V21.6H82V53H68V14.8Z"
        fill="url(#cmbSide)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M126.5 2.8L148.4 6.1C158 7.5 163.8 12.3 163.8 19.5C163.8 24.2 161.2 27.8 156.8 29.8C162.1 31.6 164.8 35.4 164.8 40.5C164.8 48.7 158.2 53.8 146.9 55.5L126.5 58.5V2.8ZM141.8 17.8V25.3H151.2C155 25.3 157.1 23.9 157.1 21.6C157.1 19.2 155 17.8 151.2 17.8H141.8ZM141.8 35.2V42.8H153C156.8 42.8 158.9 41.4 158.9 39C158.9 36.6 156.8 35.2 153 35.2H141.8Z"
        fill="url(#cmbSide)"
      />
      <defs>
